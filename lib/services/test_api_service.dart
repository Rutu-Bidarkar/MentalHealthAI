    ...
    switch (testId) {
      ...
      case 'anxiety-screening':
        return TestData(
          ...
          timeframe: 'Over the past 2 weeks, how often have you been bothered by...',
          questionCount: 7,
          estimatedTime: '2 minutes',
          maxScore: 21,
          nextTestRoute: '/tests/depression-screening',
          questions: List.generate(7, (i) => TestQuestion(
            id: 'q${i + 1}',
      ...
      case 'depression-screening':
        return TestData(
          ...
          questions: List.generate(9, (i) => TestQuestion(
            id: 'q${i + 1}',
      ...
      case 'stress-resilience':
        return TestData(
          ...
          maxScore: 80,
          nextTestRoute: null,
          questions: List.generate(20, (i) => TestQuestion(
            id: 'q${i + 1}',
