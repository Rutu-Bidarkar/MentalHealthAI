                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: GoogleFonts.loveYaLikeASister( // Requested Font
                                  fontSize: 40,
                                  color: Colors.white,
                                  shadows: [
                                    const Shadow(
                              ...
                              Text(
                                slide.description,
                                textAlign: TextAlign.center,
                                style: GoogleFonts.raleway( // Complementary font for body
                                  fontSize: 18,
                        ...
                        GestureDetector(
                          onTap: () {
                             if (_currentPage == onboardingSlides.length - 1) {
                               Navigator.pushReplacementNamed(context, '/home'); // Or /signup
                             } else {
                          ...
                          child: Container(
                            ...
                            child: Text(
                              _currentPage == onboardingSlides.length - 1 ? 'Get Started' : 'Continue',
