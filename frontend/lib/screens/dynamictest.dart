...
class _DynamicTestPageState extends State<DynamicTestPage> {
  ...
  Future<void> _finishTest() async {
    ...
    try {
      ...
      final interpretation =
          response['result_text'] ?? _calculateResultOnProbability();
  ...
  String _calculateResultOnProbability() {
    ...
    double normalized =
        (_totalScore / (_answers.length * maxSeverityPerQuestion)) * 100;
  ...
  Widget _buildResultsScreen() {
    final resultColor = _getColorForInterpretation(_finalInterpretation);
