...
enum SignupStep { userType, ageGroup, token, language, details }

enum UserType { organization, family, individual }
  ...
  Widget _buildDetailsStep() {
    return Column(
      ...
      children: [
        ...
        _InputField(controller: fullNameController, hintText: 'Full Name'),
        const SizedBox(height: 16),
        _InputField(controller: usernameController, hintText: '@username'),
        const SizedBox(height: 16),
        _DropdownField(
          value: selectedAgeGroup,
          hint: 'Select Age Group',
          items: const ['13-17', '18-25', '26-35', '36-45', '46-60', '60+'],
        ...
        _InputField(
          ...
          suffixIcon: IconButton(
            icon: Icon(Icons.location_on, color: AppTheme.colors.primary),
            onPressed: () {
